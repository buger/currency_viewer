(function($, window, undefined){    
    ...
    CurrencyManager.currencies = [
        ...
        { id: "JPY", name: "Японская йена", alt_name: "Японской йены" },
        { id: "CZK", name: "Чешская крона", alt_name: "Чешской кроны" },
        { id: "DKK", name: "Датская крона", alt_name: "Датской кроны"},
        { id: "GBP", name: "Британский фунт", alt_name: "Британского фунта" },
        { id: "HUF", name: "Венгерский форинт", alt_name: "Венгерского форинта" },
        { id: "LTL", name: "Литовский лит", alt_name: "Литовского лита" },
        { id: "LVL" },
        { id: "PLN" },
        { id: "RON" },
        { id: "SEK" },
